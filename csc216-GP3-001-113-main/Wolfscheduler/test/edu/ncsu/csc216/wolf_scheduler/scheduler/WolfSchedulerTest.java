...
public class WolfSchedulerTest {
	...
	public void testAddCourseToSchedule() {
		...
		//Attempt to add two courses with a schedule conflict
		try {
			ws.addCourseToSchedule("CSC 230", "001");
			ws.addCourseToSchedule("CSC 116", "002");
			fail();
		} catch (IllegalArgumentException iae){
			assertEquals("The course cannot be added due to a conflict.", iae.getMessage());
		}
	}
	...
	public void testAddEventToSchedule() {
		...
		//Attempt to add an event with a schedule conflict
		try {
			ws.addEventToSchedule("Monopoly", EVENT_MEETING_DAYS, EVENT_START_TIME, EVENT_END_TIME, EVENT_DETAILS);
			fail();
		} catch (IllegalArgumentException iae) {
			assertEquals("The event cannot be added due to a conflict.", iae.getMessage());
		}
	}
	...
	public void testGetScheduledActivities() {
		...
		Exception iae = assertThrows(IllegalArgumentException.class, () -> ws.addCourseToSchedule("CSC 116", "002"));
		assertEquals("The course cannot be added due to a conflict.", iae.getMessage());
